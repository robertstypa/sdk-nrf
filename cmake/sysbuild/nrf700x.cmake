...
function(setup_nrf700x_xip_data)
  ...
  sysbuild_get(CONFIG_NRF700X_SYSTEM_MODE IMAGE ${DEFAULT_IMAGE} VAR CONFIG_NRF700X_SYSTEM_MODE KCONFIG)
  sysbuild_get(CONFIG_NRF700X_RADIO_TEST IMAGE ${DEFAULT_IMAGE} VAR CONFIG_NRF700X_RADIO_TEST KCONFIG)
  sysbuild_get(CONFIG_NRF700X_SCAN_ONLY IMAGE ${DEFAULT_IMAGE} VAR CONFIG_NRF700X_SCAN_ONLY KCONFIG)
  sysbuild_get(CONFIG_NRF700X_SYSTEM_WITH_RAW_MODES IMAGE ${DEFAULT_IMAGE} VAR CONFIG_NRF700X_SYSTEM_WITH_RAW_MODES KCONFIG)
  ...
  if(SB_CONFIG_PARTITION_MANAGER)
    ...
    sysbuild_get(CONFIG_NRF_WIFI_FW_PATCH_DFU IMAGE ${DEFAULT_IMAGE} VAR CONFIG_NRF_WIFI_FW_PATCH_DFU KCONFIG)

    if(CONFIG_NRF_WIFI_FW_PATCH_DFU)
      include(${CMAKE_CURRENT_LIST_DIR}/image_signing_nrf700x.cmake)
      nrf7x_signing_tasks(${CMAKE_BINARY_DIR}/nrf70.hex ${CMAKE_BINARY_DIR}/nrf70.signed.hex nrf70_wifi_fw_patch_target)
