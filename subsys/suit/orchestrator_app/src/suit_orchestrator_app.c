...
static int nordic_top_disallowed_check(uint8_t *candidate_envelope_address,
	...
	err = suit_processor_get_manifest_metadata(candidate_envelope_address,
						   candidate_envelope_size, false,
	...
	if (suit_metadata_uuid_compare(candidate_class_id, &nordic_top_class_info.class_id) == SUIT_PLAT_SUCCESS) {
